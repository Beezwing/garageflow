-- GarageFlow — run these (updated, idempotent). 0008–0020.
-- 0010 makes the invoice live from check-in + adds technician completion.
-- 0020 makes new self-signups default to Enterprise plan (pilot phase).

-- ==== migrations/0008_user_prefs.sql ====
...
-- ==== migrations/0009_customer_portal.sql ====
...
-- ==== migrations/0010_live_invoice.sql ====
...
-- ==== migrations/0011_appointment_requests.sql ====
...
-- ==== migrations/0012_booking_photo_rls_fix.sql ====
...
-- ==== migrations/0013_safety_tips.sql ====
...
-- ==== migrations/0014_message_queue.sql ====
...
-- ==== migrations/0015_portal_approval_cast_fix.sql ====
...
-- ==== migrations/0016_invoice_discount_sign_fix.sql ====
...
-- ==== migrations/0017_no_duplicate_wo_invoice.sql ====
...
-- ==== migrations/0018_staff_approval_cast_fix.sql ====
...
-- ==== migrations/0019_notification_local_time.sql ====
...
-- ==== migrations/0020_pilot_full_access.sql ====
